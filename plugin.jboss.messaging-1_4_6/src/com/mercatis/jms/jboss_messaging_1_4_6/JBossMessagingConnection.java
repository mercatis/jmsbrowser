package com.mercatis.jms.jboss_messaging_1_4_6;
...
//	@Override
//	protected Integer getQueueMessageCount(String name) throws JMSException {
////		   ClientSession session = ...;
//		   ClientRequestor requestor = new ClientRequestor(session, "jbm.management");
//		   ClientMessage message = session.createClientMessage(false);
//		   ManagementHelper.putAttribute(message, name, "MessageCount");
